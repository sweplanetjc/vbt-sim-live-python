"""
Backtest with real Databento CME futures data (NQ - E-mini NASDAQ).

This is identical to Test_VBT_Databento.py, but uses NQ instead of ES.
...
class TesterSim:
    ...
    def run(self):
        print("Loading Databento NQ data...")
        # Load Parquet file (NQ instead of ES)
        df = pd.read_parquet("data/raw/NQ_ohlcv_1m.parquet")
        ...
        output_file = "results/sim_data_m5_databento_nq.csv"
        import os
